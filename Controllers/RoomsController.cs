...
namespace AdvancedDatabaseAndORM.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public RoomsController(AdvancedDatabaseAndORMContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Room != null ? 
                          ...
                          Problem("Entity set 'AdvancedDatabaseAndORMContext.Room'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdvancedDatabaseAndORMContext.Room'  is null.");
            }
            var room = await _context.Room.FindAsync(id);
            if (room != null)
            {
