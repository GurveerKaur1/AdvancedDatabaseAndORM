...
namespace AdvancedDatabaseAndORM.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(AdvancedDatabaseAndORMContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Client != null ? 
                          ...
                          Problem("Entity set 'AdvancedDatabaseAndORMContext.Client'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdvancedDatabaseAndORMContext.Client'  is null.");
            }
            var client = await _context.Client.FindAsync(id);
            if (client != null)
            {
