...
namespace AdvancedDatabaseAndORM.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(AdvancedDatabaseAndORMContext context)
        {
            _context = context;
        }
        ...
        {
              return View("Index", _context.Customer.ToList());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdvancedDatabaseAndORMContext.Customer'  is null.");
            }
            var customer = await _context.Customer.FindAsync(id);
            if (customer != null)
            {
